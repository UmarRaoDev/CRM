...
// Regionally-matched name banks
const NAME_POOLS = [
  {
    // Pakistani
    first: ["Umar", "Aisha", "Hamza", "Zainab", "Tariq", "Fatima", "Bilal", "Sana", "Usman", "Mariam"],
    last: ["Khan", "Siddiqui", "Ahmed", "Malik", "Chaudhry", "Qureshi", "Rehman", "Abbasi"]
  },
  {
    // Indian
    first: ["Aarav", "Priya", "Rohan", "Ananya", "Vikram", "Kavya", "Arjun", "Diya", "Rahul", "Neha"],
    last: ["Patel", "Sharma", "Verma", "Iyer", "Nair", "Gupta", "Deshmukh", "Reddy"]
  },
  {
    // American / British / Western
    first: ["Oliver", "Emma", "Liam", "Sophia", "Ethan", "Charlotte", "Mason", "Amelia", "Jack", "Olivia"],
    last: ["Miller", "Bennett", "Walsh", "Carter", "Brooks", "Mitchell", "Foster", "Hayes"]
  },
  {
    // East Asian
    first: ["Kenji", "Mei", "Min-jun", "Yuki", "Hao", "Ji-woo", "Wei", "Soo-jin"],
    last: ["Tanaka", "Park", "Chen", "Kim", "Wong", "Sato", "Li", "Zhang"]
  },
  {
    // European
    first: ["Mateo", "Elena", "Luka", "Freja", "Hugo", "Sofia", "Julian", "Clara"],
    last: ["Schneider", "Rossi", "Silva", "Kowalski", "Garcia", "Dubois", "Novak", "Weber"]
  }
];
...
// Picks a region pool first, then gets a matching first and last name
const personName = () => {
  const pool = pick(NAME_POOLS);
...
const run = async () => {
  ...
  let user = await User.findOne({ email: "raoumar514@gmail.com" });
  if (user) {
    await Promise.all([
